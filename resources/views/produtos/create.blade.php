...
<head>
    ...
    <title>Novo produto | Projeto </title>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="breadcrumb-main">
                                <h4 class="text-capitalize breadcrumb-title">Novo produto</h4>
                                <div class="breadcrumb-action justify-content-center flex-wrap">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{ route('produtos.index') }}"><i class="uil uil-estate"></i>Home</a></li>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row justify-content-center">
                                                    ...
                                                    <form action="{{ route('produtos.store') }}" method="post" onsubmit="btnsubmit.disabled = true; return true;">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="card">
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" name="novoproduto_codigo" id="novoproduto_codigo" class="form-control" value='' required>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-5">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" name="novoproduto_descricao" id="novoproduto_descricao" class="form-control" value='' required>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" name="novoproduto_custo" id="novoproduto_custo" class="form-control" value='' required>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="number" name="novoproduto_margem" id="novoproduto_margem" class="form-control" value='' placeholder="%" required>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="button-group d-flex flex-wrap pt-35 mb-35">
                                                                            <button type="submit" id="btnsubmit" class="btn btn-primary btn-default btn-squared me-15 text-capitalize">Cadastrar produto </button>
...
<script language="javascript">
    $(document).ready(function($){
        ...
        $('#novoproduto_custo').mask('#.##0,00', {reverse: true});
